...
| **R-08** | Compliance/diligence gaps: no formal SOC 2 / ISO 27001; **entity name inconsistency** (`privacy.html` says "Traxent Ltd" vs **Akpan Limited**); ICO registration to confirm | Medium | Medium | **Medium** | Run the `COMPLIANCE-ROADMAP.md` plan; reconcile legal name across all surfaces; confirm ICO data-protection-fee registration, Companies House number & registered address. | David | **Open** |
