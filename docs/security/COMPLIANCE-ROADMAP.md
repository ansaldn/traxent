...
5. **Get 2–3 auditor / certification-body quotes** (the platform will introduce partners), and **finish collecting vendor DPAs + current certifications** for AWS, Auth0, Stripe, Plausible, Resend and GitHub (`vendor-management.md`). *(Confirms real budget/timeline and completes the evidence pack.)*
